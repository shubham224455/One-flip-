...
<html lang="en">
  ...
  <body>
     ...
     <?php
      if(isset($_GET['cartduplicate']) && $_GET['cartduplicate']=="false"){
            echo'<div class="alert alert-success alert-dismissible fade show my-0" role="alert">
                <strong>Pleace order </strong> this product!!.
       ...
       if(isset($_GET['deletesuccess']) && $_GET['deletesuccess']=="true"){
        echo'<div class="alert alert-warning alert-dismissible fade show my-0" role="alert">
            <strong>Delete Cart items </strong> Success!!.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>';
     ...
     <h4 class="my-2 pd-4">Cart items! <h4>
     <div class="row">
     <?php
           ...
           if($pro_id<100 && $user_id==$userid){
                ...
                <div class="card" style="width: 14rem; height=12rem;">
                  <a href="product_page.php?product_id='.$id.'"> <img class="card-img-top" src="'.$image.'" height="300px" ></a>
                    ...
                    <a href="order.php?product_id='.$pro_id.'" class="text-dark"> 
                    <button type="button" class="btn btn-warning  "> BUY NOW </button></a>
                     <a href="cartdelete.php?product_id='.$pro_id.'" class="text-dark"><button type="button" class="btn btn-success "> Delete</button></a>
              ...
              <a href="product_page.php?product_id='.$id.'"> <img class="card-img-top" src="'.$image.'" height="300px" ></a>
                ...
                <a href="cartdelete.php?product_id='.$pro_id.'" class="text-dark"><button type="button" class="btn btn-success"> Delete</button></a>
                    ...
                    <div class="card" style="width: 14rem;height=12rem;">
                        ...
                        <p class="card-text">From ₹'.$price.'</p>
                        <div class="btn-group-lg" role="group" aria-label="Basic example">
                         <a class="card-text"><a href="order.php?product_id='.$pro_id.'" class="text-dark"> 
                          <button type="button" class="btn btn-warning "> BUY NOW </button></a>
                          <a href="cartdelete.php?product_id='.$pro_id.'" class="text-dark"> <button type="button" class="btn btn-success "> Delete</button></a>
                          </div>
